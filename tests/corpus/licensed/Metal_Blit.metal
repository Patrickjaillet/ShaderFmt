// Source: https://github.com/libsdl-org/SDL/blob/main/src/gpu/metal/Metal_Blit.metal
// License: Zlib (see repository root LICENSE.txt). Copyright the SDL
// authors and contributors. Vendored verbatim for tests/corpus/ as a
// real, license-verified open-source shader.
