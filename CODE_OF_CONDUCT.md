...
ShaderFmt project a harassment-free experience for everyone, regardless of
...
reported to the maintainer, Patrick JAILLET, by opening a confidential
report via GitHub (or by email if a security-sensitive report is required
- see [`SECURITY.md`](SECURITY.md) if present, otherwise via the contact
listed on the maintainer's GitHub profile). All complaints will be
